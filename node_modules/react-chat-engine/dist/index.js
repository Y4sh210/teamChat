...
var Socket = function Socket(props) {
  var _useState = React.useState('xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function (c) {
  ...
  var _useState2 = React.useState(Date.now() + 10000),
...
var ChatSettings = function ChatSettings(props) {
  ...
  }, props.renderChatSettingsTop ? props.renderChatSettingsTop(conn, chat) : /*#__PURE__*/React__default.createElement(ChatSettingsTop, null), props.renderPeopleSettings ? props.renderPeopleSettings(conn, chat) : /*#__PURE__*/React__default.createElement(PeopleSettings, null), props.renderPhotosSettings ? props.renderPhotosSettings(chat) : /*#__PURE__*/React__default.createElement(PhotosSettings, null), props && chat && props.userName === chat.admin.username && /*#__PURE__*/React__default.createElement("div", null, props.renderOptionsSettings ? props.renderOptionsSettings(conn, chat) : /*#__PURE__*/React__default.createElement(OptionsSettings, null))));
};
var styles$7 = {
  settingsContainer: {
    height: '100%',
...
var ChatHeader = function ChatHeader() {
  ...
  }, chat ? chat.last_message.created && chat.last_message.created.length > 0 ? "Active " + timeSinceDate(chat.last_message.created) : 'Say hello!' : 'Loading')), /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
    xs: 2,
    sm: 0,
    style: _extends({}, styles$9.mobileOptiom, {
      right: '6px'
...
var ChatFeed = function ChatFeed(props) {
  ...
  }), needsIceBreaker && props.renderIceBreaker && props.renderIceBreaker(chat), needsIceBreaker && !props.renderIceBreaker && /*#__PURE__*/React__default.createElement(IceBreaker, null), /*#__PURE__*/React__default.createElement(Messages, props), /*#__PURE__*/React__default.createElement(SendingMessages, props), /*#__PURE__*/React__default.createElement(Typers, null), /*#__PURE__*/React__default.createElement(ConnectionBar, null), /*#__PURE__*/React__default.createElement("div", {
    style: {
      height: '86px'
    },
